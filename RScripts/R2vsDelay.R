...
#plot(delays,r2s,type="l",main= paste("Current regression R^2 against quotes delay time\n",tick," on ",date,sep=""),ylab="R^2",xlab="delay (second)")
ll = length(seq(0,.5,.005)) 
#plot(delays[1:ll],r2s[1:ll],type="l",main= paste("Current regression R^2 against quotes delay time\n",tick," on ",date,sep=""),ylab="R^2",xlab="delay (second)")
par(mfrow=c(1,2))
